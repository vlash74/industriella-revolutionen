...
export const quizQuestionsNationalism: QuizQuestion[] = [
  // —— Nationalism, begrepp och spridning ——
  {
    ...
    options: [
      ...
      "Tanken att alla människor ska leva i ett enda världsrike",
      "Tanken att religion ska styra gränserna mellan stater",
      "Tanken att kungar ska ärva flera länder",
    ],
    correctAnswer:
      "Tanken att folkgrupper med egen kultur, historia och språk bör ha egen nationalstat",
  ...
  },
  {
    ...
    options: [
      "Napoleon avskaffade nationalism överallt",
      "Motståndet mot fransmännen väckte nationalistiska känslor och gemenskap hos de erövrade",
      "Napoleon tvingade alla att bli fransmän",
      "Han förbjöd alla andra språk",
    ],
    correctAnswer:
      "Motståndet mot fransmännen väckte nationalistiska känslor och gemenskap hos de erövrade",
  ...
  },
  {
    ...
    options: [
      "Skolan lärde barn att avvisa nationen",
      "Befolkningen lärde sig om nationen och dess historia och ett gemensamt nationellt språk",
      "Skolan lärde bara ut matematik",
      "Skolan var förbehållen adeln",
    ],
    correctAnswer:
      "Befolkningen lärde sig om nationen och dess historia och ett gemensamt nationellt språk",
  ...
  },
  {
    ...
    options: [
      "Att bygga järnvägar och donera blod",
      "Att vägen till ett enat rike skulle ske med våld (krig)",
      "Att alla skulle arbeta i gruvor",
      "Att förbjuda vapen",
    ],
  ...
  },
  {
    ...
    options: [
      "Frankrike glömde det snabbt",
      "Det skapade stor revanschlust i Frankrike under kommande år",
      "Frankrike erövrade hela Tyskland",
      "Det påverkade inte relationerna",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "Han erövrade Rom ensam",
      "Han avskaffade nationalismen",
    ],
    correctAnswer:
      "Han var regeringschef i Piemonte, fick Frankrike att stödja kampen mot Österrike",
  ...
  // —— Österrike-Ungern ——
  {
    ...
    options: [
      ...
      "Det erövrade Frankrike",
      "Det enades med Italien",
    ],
  ...
  },
  {
    ...
    options: [
      "Ingen särskild benämning",
      "\"Juvelen i kronan\" – Storbritanniens viktigaste koloni",
      "Den fattigaste kolonin",
      "En provins utan betydelse",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "Ett krig mellan Frankrike och Tyskland",
      "Ett handelsspel",
    ],
    correctAnswer:
      "Maktkampen mellan Storbritannien och Ryssland; Ryssland expanderade och hotade GB:s koloni Indien, Afghanistan hamnade i kläm",
  ...
  },
  {
    ...
    options: [
      ...
      "Industrialismen avskaffade imperialismen",
      "Nationalismen förbjöd kolonier",
    ],
    correctAnswer:
      "Nationalism och industrialism gav europeiska makter teknologisk och militär överlägsenhet som användes för att dominera andra delar av världen",
  ...
  // —— Från begreppslista & instuderingsfrågor ——
  {
    ...
    options: [
      "Ett land som styrs av flera kungar",
  ...
  },
  {
    ...
    options: [
      "Att man inte bryr sig om nationen",
      "Att det egna landet alltid har rätt och går före andra; nationen är allt, individen ingenting",
      "Samma som banal nationalism",
      "Endast fredliga demonstrationer",
    ],
    correctAnswer:
      "Att det egna landet alltid har rätt och går före andra; nationen är allt, individen ingenting",
  ...
  },
  {
    ...
    options: [
      "Demokrati, jämställdhet, fred, handel",
      "Kolonial expansion, ekonomisk exploatering, kulturell dominans, militär överlägsenhet",
      "Skolor, sjukvård, vägar, kyrkor",
      "Telegraf, järnväg, tidningar, flaggor",
    ],
    correctAnswer:
      "Kolonial expansion, ekonomisk exploatering, kulturell dominans, militär överlägsenhet",
  ...
  },
  {
    ...
    options: [
      ...
      "Ett inbördeskrig i ett afrikanskt land",
      "En handelsavtal mellan Afrikas länder",
    ],
    correctAnswer:
      "Europas stormakters tävlan om att erövra och kolonisera afrikanska territorier under slutet av 1800-talet",
  ...
  },
  {
    ...
    options: [
      ...
      "Telegrafen användes bara i krig",
      "Den förbjöd tidningar",
    ],
    correctAnswer:
      "Text kunde sändas snabbt över långa avstånd – budskap och idéer nådde fler",
  ...
  },
  {
    ...
    options: [
      ...
      "Endast krig användes",
      "Skolan lärde bara språk",
    ],
    correctAnswer:
      "Länder visade upp sin teknik och kultur – en slags industriell och kulturell tävling mellan nationer",
